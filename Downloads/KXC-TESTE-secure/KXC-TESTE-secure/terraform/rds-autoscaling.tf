...
# RDS: aceita conexoes PostgreSQL apenas a partir do ECS
...
# Sem regra de egress: o RDS nao inicia conexoes (as respostas usam a conexao ja estabelecida, que e stateful)
...
# Autorização para ECS ler o secret
